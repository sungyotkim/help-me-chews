...
import "./ReviewsDropDown.css";

const ReviewsDropDown = ({ styleBlack }) => {
  ...
  return (
    <div
      className="reviews-dropdown-container"
      onMouseOver={handleMouseOver}
      onMouseLeave={handleMouseOut}
    >
      <div className="reviews-dropdown" style={hoverStyle}>
      ...
      {isHovering && (
        <div className="reviews-dropdown-revealed">
          <div className="reviews-left-dropdown">
            <div className="reviews-left-dropdown-option">
              <svg>
          ...
          <div className="reviews-right-dropdown">
            <div className="reviews-right-dropdown-option">
              <svg>
